...
// リアクションキャラクター
export const furnitureReactionCharacterSchema = z
  .object({
    color: z.string(),
    id: z.string(),
    short: z.string(),
  })
  .openapi("FurnitureReactionCharacter")

export type FurnitureReactionCharacter = z.infer<typeof furnitureReactionCharacterSchema>

// リアクション
export const furnitureReactionSchema = z
  .object({
...
// タグ（カテゴリ）
export const furnitureTagSchema = z
  .object({
    furnitures: z.array(furnitureSchema),
    id: z.string(),
    name: z.string(),
  })
  .openapi("FurnitureTag")

export type FurnitureTag = z.infer<typeof furnitureTagSchema>

// レスポンス
export const furnitureListResponseSchema = z
  .object({
    data: z.object({
...
export const furnitureOwnershipResponseSchema = z
  ...
  .openapi("FurnitureOwnershipResponse")
